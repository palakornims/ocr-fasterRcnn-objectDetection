...
if __name__=='__main__':
    print(ShowResultFromModel("D:/all crop OCR/All OCR_1 (1).jpg","C:/tensorflow2/models/research/object_detection/inference_graph/OCR_Faster_Rcnn_Inception_V2.pb"))
